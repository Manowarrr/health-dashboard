...
- **[TODO]** Разработка UI-компонентов страницы:
    ...
    - **[DONE]** **Таблица продуктов:** Отображение списка всех продуктов с колонками (Название, Калории, БЖУ).
        
    - **[DONE]** **Поиск и фильтрация:** Поле для поиска по названию.
        
    - **[DONE]** **Кнопка "Добавить продукт":** Открывает существующее модальное окно для добавления.
        
    - **Элементы управления в строке:** Кнопки "Редактировать" и "Удалить" для каждого продукта.
        
- **[TODO]** **Доработка формы добавления/редактирования продукта:** Убедиться, что форма содержит поля для **всех** показателей: Калории, Белки, Жиры, Углеводы, Клетчатка, Сахар, Алкоголь, Кофеин.
